...
var Validator = function (_React$Component) {
    ...
    _createClass(Validator, null, [{
        ...
        value: function propTypes() {
            ...
            reference: _propTypes2.default.any.isRequired;
            validationRules: _propTypes2.default.object.isRequired;
            validationMessages: _propTypes2.default.object.isRequired;
            isValidationError: _propTypes2.default.func.isRequired;
        }
    }]);
    ...
    _createClass(Validator, [{
        ...
        value: function componentDidUpdate(prevProps) {
            ...
            var _props = this.props,
                ...
                isValidationError = _props.isValidationError;

            if (!(0, _lodash.isEqual)(isFormSubmitted, prevProps.isFormSubmitted) || !(0, _lodash.isEqual)(reference, prevProps.reference)) {
                if (validationRules) {
                    var flag = true;
